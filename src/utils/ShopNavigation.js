...
export class ShopNavigation {
  ...
  init() {
    ...
    // Обновляем видимость кнопок при скролле
    this.allItemsContainer.addEventListener("scroll", () => this.updateButtonVisibility());
  ...
  addEnhancedSwipeListeners() {
    this.allItemsContainer.addEventListener('touchstart', this.handleTouchStart.bind(this), { passive: false });
    this.allItemsContainer.addEventListener('touchmove', this.handleTouchMove.bind(this), { passive: false });
    this.allItemsContainer.addEventListener('touchend', this.handleTouchEnd.bind(this), { passive: true });
  }
  ...
  destroy() {
    ...
    this.allItemsContainer.removeEventListener("scroll", this.updateButtonVisibility);
    
    // Удаляем свайп listeners
    this.allItemsContainer.removeEventListener('touchstart', this.handleTouchStart);
    this.allItemsContainer.removeEventListener('touchmove', this.handleTouchMove);
