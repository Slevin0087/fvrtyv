...
export const GameEvents = {
  ...
  SET_MODES_CHANGE: "set:modes:change",
  SET_MUSIC_VOLUME: "set:music:volume",
  SET_MUSIC_TOGGLE: "set:music:toggle",
  ...
  SET_ASSISTANCE_IN_CARD_CLICK: "set:assistance:in:card:click",
  SET_NO_HINTS: "set:no:hints",
  SET_GAME_PAUSE_STATUS: "set:game:pause:status",
  SET_BG_FOR_JOKER_ELEMENT: "set:bg:for:joker:element",
  GAME_NEW: "game:new",
  ...
  ADD_CARD_FRONT_IMAGE: "add:card:front:image",
  ADD_CARD_FRONT_CLASS: "add:card:front:class",
  ADD_CARD_BACK_IMAGE: "add:card:back:image",
  ADD_CARD_BACK_CLASS: "add:card:back:class",
  ...
  ANIMATE_JOKER_FLIP: "animate:joker:flip",
  ...
  CREAT_ELEMENT_FOR_NOTIF_SHUFFLED_CARDS:
    "creat:element:for:notif:shuffled:cards",
