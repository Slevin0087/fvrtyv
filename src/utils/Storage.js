...
export class Storage {
  constructor() {
    ...
    this.defaultPlayerStats = {
      ...
      purchasedItems: {
        faces: {
          ids: ["start_classic_faces"],
        },
        backs: {
          ids: ["start_classic_back_img", "classic_back", "dice_back"],
        },
        backgrounds: {
          ids: ["green_classic_fon", "green_classic_fon_img"],
        },
      },
      selectedItems: {
        faces: {
  ...
  setPlayerStats(stats) {
    ...
    console.log("в setPlayerStats stats", stats);
    const playerStats = {
      ...storage,
      ...stats,
    };
